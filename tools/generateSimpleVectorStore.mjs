...
async function generateSimpleVectorStore() {
  ...
  const outputPath = path.join(__dirname, "../vector_store/simple_vector_store.json");
  ...
  console.log(`Saved ${processedDocs.length} documents with embeddings to ${outputPath}`);
}
