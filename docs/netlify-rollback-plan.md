...
curl -s http://localhost:3080/.netlify/functions/lastplayed | jq '.artist' && echo "✅ lastplayed function working"
curl -s http://localhost:3080/.netlify/functions/latestUploads | jq 'length' && echo "✅ latestUploads function working"
