...
{% image "./content/articles/our-educational-innovation-plan/js-fetch-chatgpt.png", "ChatGPT fetch example", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "./content/articles/our-educational-innovation-plan/vscode-codespaces.png", "VS Code using Codespaces", "(min-width: 30em) 50vw, 100vw" %}
...
- Energy efficiency and optimisation: Teach energy-efficient programming practices and techniques where resources are minimised, and we attempt to reduce unnecessarily compute time. Thus reducing the energy consumption of servers (Abhishek et al., 2021)[^7].
- Promote reduced cost: By optimising efficiency, the software can require smaller servers to reduce the cost of hosting.

The reduced cost benefit is an easy sell to employers, and if each graduate can help make environmentally sustainable efforts in New Zealand, get a little closer to our carbon reduction goals of 2050, and hopefully impact climate change.
