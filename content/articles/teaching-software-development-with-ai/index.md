...
{% figure "./content/articles/teaching-software-development-with-ai/js-fetch-chatgpt.png", "ChatGPT fetch example" %}
...
{% figure "./content/articles/teaching-software-development-with-ai/vscode-copilot.png", "Visual Studio Code with GitHub Copilot" %}
...
{% figure "./content/articles/teaching-software-development-with-ai/vscode-codespaces.png", "Visual Studio Code using Codespaces" %}
