...
{% figure "./icon-clear.jpg", "Clear Icon" %}
...
{% figure "./icon-camera+.jpg", "Camera+ Icon" %}
...
{% figure "./icon-yahoo-weather.jpg", "Yahoo Weather Icon" %}
...
{% figure "./icon-google-maps.jpg", "Google Maps Icon" %}
...
{% figure "./icon-authy.jpg", "Authy Icon" %}
...
{% figure "./icon-evernote.jpg", "Evernote Icon" %}
...
{% figure "./icon-tydlig.jpg", "Tydlig Icon" %}
...
{% figure "./icon-reeder.jpg", "Reeder Icon" %}
...
{% figure "./icon-instapaper.jpg", "Instapaper Icon" %}
...
{% figure "./icon-readquick.jpg", "ReadQuick Icon" %}
...
{% figure "./icon-tweetbot.jpg", "Tweetbot 3 Icon" %}
...
{% figure "./icon-overcast.jpg", "Overcast Icon" %}
...
{% figure "./icon-day-one.jpg", "Day One Icon" %}
...
{% figure "./icon-plex.jpg", "Plex Icon" %}
...
{% figure "./icon-skype.jpg", "Skype Icon" %}
...
{% figure "./icon-mailbox.jpg", "Mailbox Icon" %}
...
{% figure "./icon-chronicle.jpg", "Chronicle Icon" %}
