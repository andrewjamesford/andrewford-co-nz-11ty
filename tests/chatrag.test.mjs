...
process.env.UPSTASH_REDIS_REST_URL = process.env.UPSTASH_REDIS_REST_URL || "mock-redis-url";
...
process.env.ALLOWED_ORIGINS = process.env.ALLOWED_ORIGINS || "https://andrewford.co.nz,http://localhost:8888";
...
describe("chatrag Netlify Function", () => {
  ...
  it("should include proper CORS headers", async () => {
    const event = {
      body: JSON.stringify({ question: "What is your favorite programming language?" }),
      headers: {
        "content-type": "application/json",
        origin: "https://andrewford.co.nz"
      },
